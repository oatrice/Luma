...
### Phase 5: UI Upgrade (Day 5)

| # | Task | Estimate | Priority |
|---|------|----------|----------|
| 5.1 | Redesign main menu with state display | 2h | 🔴 High |
| 5.2 | Show active task and next step | 1h | 🔴 High |
| 5.3 | Add progress indicator | 1h | 🟡 Medium |
| 5.4 | Color-coded status display | 1h | 🟢 Low |

### Phase 6: Project Config (Day 5)

| # | Task | Estimate | Priority |
|---|------|----------|----------|
| 6.1 | สร้าง `.luma_rules.json` schema | 1h | 🟡 Medium |
| 6.2 | Create config for JarWise | 1h | 🟡 Medium |
| 6.3 | Loader for project rules | 1h | 🟡 Medium |
