...
- [ ] **Step 1**: In [JarWise/.luma_rules.json](file:///Users/oatrice/Software-projects/JarWise/.luma_rules.json), add a dummy check:
  ```json
  {
    "id": "must_fail",
    "type": "file_exists",
...
- [ ] **Step 3**: Verify it lists "Follow Material Design 3" (from [.luma_rules.json](file:///Users/oatrice/Software-projects/JarWise/.luma_rules.json)).
...
- [ ] **Check**: Fails if `CHANGELOG.md` is not modified (Rule: [file_modified](file:///Users/oatrice/Software-projects/Luma/luma_core/preflight_checker.py#50-69)) (Phase 6).
