...
@patch("luma_core.actions.admin_actions.safe_input", side_effect=["1", "2", "7"]) # 1: Change LLM, 2: OpenRouter, 7: Back
...
@patch("luma_core.actions.admin_actions.safe_input", side_effect=["2", "1", "7"]) # 2: Change CLI, 1: Gemini CLI, 7: Back
@patch("builtins.print")
...
@patch("luma_core.config.save_fallback_index")
@patch("luma_core.actions.admin_actions.safe_input", side_effect=["1", "4", "7"])  # 1: Change LLM, 4: Codex CLI, 7: Back
@patch("builtins.print")
